...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheEVEOE -X kill
screen -S TheEVEOE ./TheEVEOE
done
]])
Run:close()
...
return {
Lock     = '[‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›](https://t.me/EVEOE)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›](https://t.me/EVEOE)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›](https://t.me/EVEOE)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›](https://t.me/EVEOE)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›](https://t.me/EVEOE)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›](https://t.me/EVEOE)\n*— — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
Redis:incr(TheEVEOE.."EVEOE:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheEVEOE.."EVEOE:Lock:Contact"..msg_chat_id)
...
if text == 'رفع نسخه سناب' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم استرجاع المجموعات من نسخه سناب')
else
...
Redis:set(TheEVEOE.."EVEOE:AddSudosNew"..msg_chat_id,true)
...
LuaTele.sendText(msg_chat_id,msg_id,"*᥀︙حساب المالك محذوف*","md",true)  
return false
end
...
local TextingDevTheEVEOE = Redis:get(TheEVEOE..'EVEOE:Texting:DevTheEVEOE')
if TextingDevTheEVEOE then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevEVEOE,"md",true)  
else
local photo = LuaTele.getUserProfilePhotos(Sudo_Id)
if photo.total_count > 0 then
local ban = LuaTele.getUser(Sudo_Id)
local T = '‹ 𝖣𝖾𝗏 𝖴𝗌𝖾𝗋 : @'..UserSudo..' \n‹ 𝖣𝖾𝗏 𝖡𝗈𝗍  : ['..ban.first_name..'](tg://user?id='..ban.id..')\n— — — — — — — —\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 . ›', url = "https://t.me/EVEOE"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if Redis:get(TheEVEOE.."EVEOE:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
{
{text = 'Facebook', url = 'https://www.facebook.com/help/deleteaccount'},{text = 'EVEOEchat', url = 'https://accounts.EVEOEchat.com/accounts/login?continue=https%3A%2F%2Faccounts.EVEOEchat.com%2Faccounts%2Fdeleteaccount'}
},
{
{text = '‹ 𝖲𝗇𝖺𝗉 𝖳𝖾𝖺𝗆 ›', url = 't.me/EVEOE'}, 
},
...
photo = "http://t.me/EVEOE/157"
local T =[[
╔━━━━━━━━𓄼•🤍•𓄹━━━━━━━╗ 
┇⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ EVEOE⦒ 
╚━━━━━━━━𓄼•🤍•𓄹━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '༄ Developer', url = "https://t.me/moqtad_a"},{text = ' ༄ Exp Source .', url = "http://t.me/EVEOE"}
},
{
{text = ' ༄ Tws EVEOE', url = "http://t.me/EVEOEbot"}
},
{
{text = ' ༄ Source Channel', url = "http://t.me/EVEOE"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == "بوت" then
local NamesBot = (Redis:get(TheEVEOE.."EVEOE:Name:Bot") or "سناب")
local BotName = {
...
if text == (Redis:get(TheEVEOE.."EVEOE:Name:Bot") or "سناب") then
local NamesBot = (Redis:get(TheEVEOE.."EVEOE:Name:Bot") or "سناب")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheEVEOE.."EVEOE:Name:Bot") or "سناب")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/EVEOE'},{text = '᥀ لتنصيب بوت .', url = 't.me/DRRDDDP'}, 
},
{
