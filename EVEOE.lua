...
if photo.total_count > 0 then
local TestText = "EVEOE 𝖲𝗈𝗎𝗋𝖼𝖾\n— — — — — — — — —\n※︙*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n※︙*Dev Bio* : [ "..Bio.." ]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '- 𝖱𝖺𝗌𝗎𝗅 .𝖬𝗎𝗇𝗍𝖺ᴢ𝖺𝗋 .', url = "https://t.me/moqtad_a"}
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
  ...
  local T =[[*
  - 𝖶𝖾𝗅𝖼𝗈𝗆𝖾  𝖲𝗈𝗎𝗋𝖼𝖾 Snap 𝖳𝖾𝖺𝗆 .
  - 𝖳𝗁𝖾 𝗅𝖺𝗋𝗀𝖾𝗌𝗍 𝗉𝗋𝗈𝖿𝖾𝗌𝗌𝗂𝗈𝗇𝖺𝗅 𝗉𝗅𝖺𝗍𝖿𝗈𝗋𝗆 𝗌𝗉𝖾𝖼𝗂𝖺𝗅𝗂𝗓𝖾𝖽 𝗂𝗇 𝖬𝖺𝗄𝗂𝗇𝗀 𝖳𝖾𝗅𝖾𝗀𝗋𝖺𝗆 𝖡𝗈𝗍𝗌 .
  - اكبر  منصة أحترافية متخصصة لصنع الروبوتات :* [‹ Snap 𝖳𝖾𝖺𝗆 . › ⁦](https://t.me/RRRRWR)
  ]]
  keyboard = {} 
  keyboard.inline_keyboard = {
  {
  ...
  {
  {text = '‹ Snap 𝖳𝖾𝖺𝗆 . › ⁦', url = "https://t.me/RRRRWR"}
  },
  }
  local msgg = msg_id/2097152/0.5
