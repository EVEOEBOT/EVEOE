...
data = {
{
{text = 'C𝘩𝘢𝘯𝘯𝘦𝘭 E𝘷𝘦𝘰𝘦 √', url = 't.me/EVEOE'}, 
},
}
}
...
Redis:incrby(TheEVEOE.."EVEOE:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
{
{text = 'الالعاب الاحترافيه ', data = IdUser..'/degm'}, 
},
{
{text = 'Eveoe 𝖳𝖾𝖺𝗆 ⁦', url = 't.me/EVEOE'}, 
},
