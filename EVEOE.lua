...
if text and Redis:get(itsRaumo..'Raumo:GetTexting:DevitsEVEOE'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(itsRaumo..'Raumo:GetTexting:DevitsEVEOE'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(itsRaumo..'Raumo:Texting:DevitsEVEOE',text)
Redis:del(itsRaumo..'Raumo:GetTexting:DevitsEVEOE'..msg_chat_id..':'..msg.sender.user_id)
...
if text and text:match("^(.*)$") then
if Redis:get(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(itsRaumo.."EVEOE1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(itsRaumo.."EVEOE1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(itsRaumo.."EVEOE1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(itsRaumo..'EVEOE1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(itsRaumo..'EVEOE1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(itsRaumo..'EVEOE1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(itsRaumo.."EVEOE1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(itsRaumo.."EVEOE1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(itsRaumo.."EVEOE1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(itsRaumo.."EVEOE1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(itsRaumo.."EVEOE1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(itsRaumo.."EVEOE1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(itsRaumo.."EVEOE1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(itsRaumo.."EVEOE1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(itsRaumo.."EVEOE1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(itsRaumo.."EVEOE1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(itsRaumo.."EVEOE11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(itsRaumo.."EVEOE11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(itsRaumo.."EVEOE11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(itsRaumo..'EVEOE11:Add:Rd:Sudo:Text'..text)
Redis:del(itsRaumo..'EVEOE11:Add:Rd:Sudo:Text1'..text)
Redis:del(itsRaumo..'EVEOE11:Add:Rd:Sudo:Text2'..text)
Redis:del(itsRaumo.."EVEOE11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(itsRaumo.."EVEOE11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(itsRaumo.."EVEOE11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text"..v) 
Redis:del(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text1"..v) 
Redis:del(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text2"..v)   
Redis:del(itsRaumo.."EVEOE11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(itsRaumo.."EVEOE11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(itsRaumo.."EVEOE11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(itsRaumo.."EVEOE11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(itsRaumo.."EVEOE11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(itsRaumo.."EVEOE11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(itsRaumo.."EVEOE11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:set(itsRaumo..'Raumo:GetTexting:DevitsEVEOE'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(itsRaumo..'Raumo:Texting:DevitsEVEOE')
...
if text == (Redis:get(itsRaumo.."Raumo:Name:Bot") or "EVEOE") then
local NamesBot = (Redis:get(itsRaumo.."Raumo:Name:Bot") or "EVEOE")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(itsRaumo.."Raumo:Name:Bot") or "EVEOE")..
...
Redis:del(itsRaumo.."EVEOE1:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(itsRaumo.."EVEOE1:Set:Rd"..IdUser..":"..ChatId, "true")
