...
return {
Lock     = '[قناة السورس](https://t.me/EVEOE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[قناة السورس](https://t.me/EVEOE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[قناة السورس](https://t.me/EVEOE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[قناة السورس](https://t.me/EVEOE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[قناة السورس](https://t.me/EVEOE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[قناة السورس](https://t.me/EVEOE)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
Redis:del(TheKOIA.."kOIA:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheKOIA.."kOIA:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
download('https://raw.githubusercontent.com/EVEOEBOT/EVEOE/master/KOIA.lua','KOIA.lua')
...
{
{text = '『 𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐄𝑳𝐀𝐍𝐎』', url = 't.me/EVEOE'},
},
}
}
if not msg.ControllerBot then
...
Redis:set(TheKOIA.."KOIA:Set:Id:Group"..msg.chat_id,Text_Rand)
...
{
{text = '❲ 𝐒𝐎𝐔𝐑𝐂𝐄 ❳', url = "https://t.me/QQOQQD"}
},
}
...
{
{text = 'قناة السورس', url = "https://t.me/EVEOE"}
},
}
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
Redis:del(TheKOIA.."KOIA:TheBasicsQ:Group"..msg_chat_id) 
...
data = {
{
{text = '.َ ‹ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐄𝑳𝐀𝐍𝐎 ⁦⁦.𖨬', url = 't.me/G0BBBI'}, 
},
}
}
...
data = {
{
{text = '.َ ‹ 𝐒𝐎𝐔??𝐂𝐄 𝐌𝐄𝑳𝐀𝐍𝐎 ⁦⁦.𖨬', url = 't.me/G0BBBI'}, 
},
}
}
...
data = {
{
{text = '.َ ‹ 𝐒𝐎??𝐑𝐂𝐄 𝐌𝐄𝑳𝐀𝐍𝐎 ⁦⁦.𖨬', url = 't.me/G0BBBI'}, 
},
}
}
...
if text == (Redis:get(TheKOIA.."KOIA:Name:Bot") or "ايفو") then
local NamesBot = (Redis:get(TheKOIA.."KOIA:Name:Bot") or "ايفو")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheKOIA.."KOIA:Name:Bot") or "ايفو")..
...
{
{text = '-  𝖲𝗈𝗎𝗋𝖼𝖾 EVEOE.', url = 't.me/EVEOE'}, 
},
}
}
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس ايفو اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{
{text = '-  𝖲𝗈𝗎𝗋𝖼𝖾 𝗄𝖺𝖽𝗂.', url = 't.me/G0BBBI'}, 
},
}
}
local TextHelp = [[*
