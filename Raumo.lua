...
return {
Lock     = '[- TeaM Raumo .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[- TeaM Raumo .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- TeaM Raumo .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[- TeaM Raumo .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[- TeaM Raumo .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[- TeaM Raumo .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = 'sourceRaumo', url='https://t.me/EKKKK6'},
},
}
}
...
download('https://raw.githubusercontent.com/SourceitsRaumo/itsRaumo/master/Raumo.lua','Raumo.lua')
...
{{text = '❲ Raumo 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/EKKKK6"}},
}
...
{
{text = '❲ Source Raumo ❳', url = "https://t.me/EKKKK6"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/remixsource/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == (Redis:get(itsRaumo.."Raumo:Name:Bot") or "Raumo") then
local NamesBot = (Redis:get(itsRaumo.."Raumo:Name:Bot") or "Raumo")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات Raumo بعدين اجاوبك",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(itsRaumo.."Raumo:Name:Bot") or "Raumo")..
